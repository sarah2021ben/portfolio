      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 overflow-y-auto xl:overflow-visible">
        ...
        <div className="flex flex-1 flex-col justify-center ">
          ...
          <p className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0">
            ...
            rerum obcaecati voluptatibus consequuntur, odio nobis, quidem non d
            id fugit. Vel, perferendis!
          </p>
          {/**counters */}
          <div className="hidden md:flex md:max-w-xl xl:max-w-none mx-auto xl:mx-0 mb-8">
            <div className="flex flex-1 wl:gap-x-6">
              {/*experience */}
              <div className="relative flex-1 xl:justify-items-center after:w-px after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
              ...
              {/*awards */}
              <div className="relative flex-1 xl:justify-items-center">
                <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2">
                  <CountUp start={0} end={250} duration={10} /> +
                </div>
                <div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px] ">
